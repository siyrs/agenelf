...
> 状态：Node Agent/API/CLI 已是默认生产入口；Validation Runner 已迁移；其余安全 Runner 分批迁移  
...
要求：Node test、Python regression、专项 Runner E2E、Security、CodeQL、Compose smoke 全绿后才能切换默认运行时。
